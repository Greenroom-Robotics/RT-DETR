...
# Run this bash script  with `nohup bash gr_train.sh &`
...
python3 tools/train.py -c /home/ros/RT-DETR/configs/gr/rtdetrv2_r18vd_120e_gr_1280.yml -t /home/ros/RT-DETR/checkpoints/rtdetrv2_r18vd_120e_coco_rerun_48.1.pth --use-amp --seed=0 > exp1.log 2>&1
